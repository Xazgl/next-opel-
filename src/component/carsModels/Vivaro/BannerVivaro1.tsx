             ...
             <div className='descriptionZafira'>
              ...
              <div className='complectation'>
                <div className='content'>
                 ...
                 <div className="complTitle">SELECTION М</div>
                 <div className="complUl">
                   <ul>
                     <li>Дизельный двигатель 2.0 (150)</li>
                     <li>Механическая, пятиступенчатая коробка передач</li>
                     <li>Полная масса 2495</li>
                     <li>Длинна кузова 4959мм</li>
                   </ul>
                   <div className="complTitle">ОТ 2 200 900 ₽</div>
                  </div>
                </div>
                <div className='content'>
                 <div className="comImg"></div>
                 <div className="complTitle">SELECTION L</div>
                 <div className="complUl">
                   <ul>
                     <li>Дизельный двигатель 2.0 (150)</li>
                     <li>Механическая, пятиступенчатая коробка передач</li>
                     <li>Полная масса 3106</li>
                     <li>Длинна кузова 5309мм</li>
                   </ul>
                   <div className="complTitle">ОТ 2 400 000 ₽</div>
                  </div>
                </div>
              </div>
